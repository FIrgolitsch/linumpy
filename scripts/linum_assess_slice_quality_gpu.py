...
def write_slice_config_with_quality(
    ...
    """Write ``slice_config.csv`` with decision columns only.

    Raw per-metric scores live in the per-stage diagnostics JSON / pipeline
    report, not in the per-slice decision trace.
    """
