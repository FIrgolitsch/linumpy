...
Full upstream-first diagnostic workflow, pass/fail gates, config notes, and rerun rules:
→ `.planning/RECON-DIAGNOSTIC-PLAYBOOK.md`

**PR chain operations** (routing work to stacked PRs, inventory refresh, optional merge wave):
→ `.planning/PR-CHAIN-OPS.md` (tracker: `.planning/phases/05-pr-chain-merge-execution/05-PR-MERGE-TRACKER.md`)
